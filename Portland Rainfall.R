...
drd$Rainday[drd$Rain > 0 & drd$Rain < 0.05] <- 0.05
drd$Rainday[drd$Rain > 0.05 & drd$Rain < 0.25] <- 0.25
...
q <- ggplot(drd, aes(newDay, Year, fill =  as.factor(Rainday))) + 
  ...
  scale_y_continuous(limits = c(1945,2022), breaks = seq(1946,2021,1)) +
